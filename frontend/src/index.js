const addressContrac = '0x60F4f1993CC5811FeC737E653d23f19049ec115c';
...
const addressDestiny = '0x3EffF8acD27EE9137A83C054efB22c019514f957'
...
const interact = () =>{
    ...
    transferBtn.addEventListener('click',()=>{
        ...
        MyCoin.methods.transfer(addressDestiny,amount ).send({from: account}).then(res=>{
            console.log('tx done!');
        })
    })
}
